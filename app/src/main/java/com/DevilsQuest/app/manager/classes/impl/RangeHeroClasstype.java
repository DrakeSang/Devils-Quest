...
@Component
@Qualifier("RANGE")
public class RangeHeroClasstype extends ClassFighTypeDetails implements HeroClassDetailsManager {
    @Autowired
    public RangeHeroClasstype(
    ...
    public HeroClass getHeroClass() {
        return getHeroClassDetails(ClassFightType.RANGE);
    }    
}